...
Todos os projetos listados acima agora têm um conjunto completo de documentação — o que é, como instalar, todas as configurações que oferece, como compilar a partir do código-fonte e quem o escreveu. E tudo isso existe em **seis idiomas**: inglês, russo, espanhol, português do Brasil, romeno e chinês simplificado, com 84 páginas cada.
