...
<head>
  <title>Metamod-R: Obsługiwane gry | ReHLDS</title>
</head>

# Obsługiwane gry

Zapaleńcy ze społeczności przyjrzeli się znanym wersjom _Metamoda_,
...
* [metamod-p-cmake](https://github.com/SamVanheer/Metamod-P-CMake/blob/master/metamod/games.h) (zwykły fork, zoptymalizowany pod kompilację CMake)
...
zestawili przejrzystą i aktualną listę modyfikacji, sprawdzili (**`pobieżnie*`**) ich działanie i dodali obsługę tych gier „od ręki” w **[Metamod-r](https://github.com/rehlds/metamod-r)**. 

## Obsługiwane gry
:heavy_check_mark: - Obsługiwana :x: - Nieobsługiwana :interrobang: - Częściowo obsługiwana, ale wciąż z problemami  :star: - Przetestowana przez społeczność

| Gra \ Modyfikacja | ![](https://i.imgur.com/t23p9tU.png) | ![](https://i.imgur.com/AzhAYR4.png) | Uwaga
| ------------- | ------| ------|------|
...
| [Azure Sheep](http://www.moddb.com/mods/azure-sheep/downloads/) | :heavy_check_mark: |  :x: |  Brak plików wykonywalnych dla Linuksa.
| [Base Defense](http://www.moddb.com/mods/b-def/downloads/) |  :heavy_check_mark: |  :heavy_check_mark: | 
| [Brain Bread](http://www.moddb.com/mods/brainbread/downloads/) | :heavy_check_mark: |  :x: | Brak plików wykonywalnych dla Linuksa.
| [Brutal Half-Life](http://www.moddb.com/mods/brutal-half-life/downloads/) | :heavy_check_mark: |  :x: |  Brak plików wykonywalnych dla Linuksa.
| [Bumper Cars](http://www.moddb.com/mods/bumper-cars/downloads/) |   :heavy_check_mark: |  :x: | Brak plików wykonywalnych dla Linuksa.
| [BuzzyBots](http://www.moddb.com/mods/buzzybots/downloads) | :heavy_check_mark: |  :x: | Brak plików wykonywalnych dla Linuksa.
| [Chicken Fortress 3](http://www.moddb.com/mods/chicken-fortress-3/downloads/) | :heavy_check_mark:  | :x: | Brak plików wykonywalnych dla Linuksa.
| [Counter-Strike 1.0](http://www.moddb.com/mods/counter-strike/downloads/counter-strike-10-for-steam) | :heavy_check_mark:  | :x: | Brak plików wykonywalnych dla Linuksa. 
| [Counter-Strike 1.5](http://www.moddb.com/mods/counter-strike/downloads/counter-strike-15-for-steam) | :heavy_check_mark:  | :x: | Brak plików wykonywalnych dla Linuksa.
...
| [Counter-Strike:Condition Zero Deleted Scenes](http://store.steampowered.com/app/80/CounterStrike_Condition_Zero/) | :heavy_check_mark: | :heavy_check_mark: | Modyfikacja jednoosobowa oparta na trybie wieloosobowym.
...
| [Existence](http://www.moddb.com/mods/existence/downloads/) | :heavy_check_mark: |  :x:  | Brak plików wykonywalnych dla Linuksa.
| [Firearms](http://www.moddb.com/mods/firearms/downloads/) | :heavy_check_mark: |  :x:  | Brak plików wykonywalnych dla Linuksa.
| [Frontline Force](http://www.moddb.com/mods/front-line-force/downloads/) | :heavy_check_mark: |  :heavy_check_mark: 
| [Gangsta Wars](http://www.moddb.com/mods/gangsta-wars/downloads/) | :heavy_check_mark: |  :x: | Brak plików wykonywalnych dla Linuksa.
| [Gangwars](http://www.moddb.com/mods/gangwars/downloads/) | :heavy_check_mark: |  :x: | Brak plików wykonywalnych dla Linuksa.
| [Global Warfare](http://www.moddb.com/mods/global-warfare/downloads/) | :heavy_check_mark: |  :heavy_check_mark: 
| [Goldeneye](http://www.moddb.com/mods/goldeneye-mod/downloads/) | :heavy_check_mark: |  :x: | Brak plików wykonywalnych dla Linuksa.
| [Gunman Chronicles](http://www.moddb.com/games/gunman-chronicles/downloads/gunman-chronicles-steam-version/) | :heavy_check_mark: |  :x: | Brak plików wykonywalnych dla Linuksa.
| [HL-Rally](http://www.moddb.com/mods/hl-rally/downloads/) | :heavy_check_mark: |  :heavy_check_mark: |  
| [Half-Life](http://store.steampowered.com/app/70/HalfLife/) :star: | :heavy_check_mark: | :heavy_check_mark: | Alternatywny klient: [Bugfixed and improved HL release](https://github.com/LevShisterov/BugfixedHL) :star: .
...
| [Half-Life: Blue Shift](http://store.steampowered.com/app/130/HalfLife_Blue_Shift/) | :heavy_check_mark: | :heavy_check_mark: | Modyfikacja jednoosobowa oparta na trybie wieloosobowym.
| [Half-Life: Decay](http://www.moddb.com/mods/half-life-decay/downloads/) :star:| :heavy_check_mark: | :x: | Brak plików wykonywalnych dla Linuksa.
...
| [Master Sword](http://www.moddb.com/mods/master-sword/downloads/) [Continued](http://www.moddb.com/mods/master-sword-continued-111/downloads) | :heavy_check_mark: |  :x: | Brak plików wykonywalnych dla Linuksa.
...
| [Natural Selection](https://unknownworlds.com/ns/) :star:| :heavy_check_mark: | :heavy_check_mark: | Także wersja `Beta`. 
| [Open-Source Jailbreak](http://www.moddb.com/mods/open-source-jailbreak/downloads/) | :heavy_check_mark: |  :heavy_check_mark: |
| [openAG](https://github.com/YaLTeR/OpenAG) |  :heavy_check_mark: |   :heavy_check_mark: | Alternatywny klient o otwartym kodzie dla modyfikacji `Adrenaline Gamer`.
...
| [Out Break](http://www.moddb.com/mods/outbreak-half-life/downloads/) | :heavy_check_mark: |  :x: | Brak plików wykonywalnych dla Linuksa.
...
| [StargateTC](http://www.moddb.com/mods/stargatetc/downloads/) :star:| :heavy_check_mark:  |  :heavy_check_mark: | Wszystkie wersje: `1.x` i `2.x`.
| [Sven Coop](http://store.steampowered.com/app/225840/Sven_Coop/) :star: | :interrobang:  |  :interrobang: | **Uwaga!** Wersje `legacy` i użytkownicy starego `steam 5.x` napotykają problemy: [#1](https://github.com/rehlds/metamod-r/issues/17#issuecomment-362253473), [#2](https://github.com/rehlds/metamod-r/issues/29). _**Problem został rozwiązany**_ w wersji `steam` [#3](https://github.com/rehlds/metamod-r/issues/45) przez twórców począwszy od [Build 3082297](https://forums.svencoop.com/showthread.php/45308-Sven-Co-op-Update-Released-Build-3082297).
...
| [Wizard Wars](http://www.moddb.com/mods/wizard-wars/downloads/) | :heavy_check_mark: |  :heavy_check_mark: | Także wersja `Beta`. 
...
* _modyfikacje, poza `Counter-Strike 1.6`, `Half-Life 1` i pozostałymi oznaczonymi :star:, sprawdzono jedynie pod kątem udanego uruchomienia w środowisku [ReHLDS](https://github.com/rehlds/ReHLDS) + [Metamod-r](https://github.com/rehlds/metamod-r). Nie prowadzono dokładnych testów. Tabela zgodności ma charakter orientacyjny. Obecnie testy są dokładniejsze i staramy się wychwycić wszystkie problemy modyfikacji._
...
Gra ma zmieniony limit wstępnego wczytywania obiektów w silniku i w kliencie. Ponieważ metamod-r wymaga rehlds, limit po stronie serwera wraca do standardowych 512 obiektów. W efekcie modyfikacja nie działa na mapach, które ten limit przekraczają (tryb kooperacji na mapach kampanii). Jednocześnie standardowe mapy wieloosobowe, takie jak `crossfire`, działają bez zarzutu. (_To nie jest błąd [metamod-r #29](https://github.com/rehlds/metamod-r/issues/29) ani [rehlds #591](https://github.com/rehlds/ReHLDS/issues/591), ale wpływa na oba_). 

##### Jak to naprawić:
* Spróbuj zaktualizować wersję `steam` svencoop do [Build 3082297](https://forums.svencoop.com/showthread.php/45308-Sven-Co-op-Update-Released-Build-3082297).

> Przywrócono zgodność API/ABI z oryginalnym GoldSrc/Metamod-P. Własna wersja Metamod-P dla Sven Co-op nie jest już potrzebna (i w praktyce przestanie działać).

##### Obejścia:
* Spróbuj użyć ![](https://i.imgur.com/AzhAYR4.png) [metamod_unprecacher](https://github.com/In-line/metamod_unprecacher) albo czegoś podobnego, żeby zablokować nieużywane zasoby.  `nieprzetestowane`
* Spróbuj skompilować własną wersję rehlds z podwyższonym limitem, takim jak w svencoop.  `nieprzetestowane`
